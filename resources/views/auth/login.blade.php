...
<body class="min-h-screen flex items-center justify-center bg-[#072ac8] bg-no-repeat text-gray-800 px-4">
    ...
    >
        ...
        <!-- Subjudul -->
        <h4 class="text-center text-xl font-semibold mb-4 text-blue-600">Login Akun</h4>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="mb-6">
                ...
                <div class="relative">
                    <input 
                        ...
                        id="password" 
                        required 
                        class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500 pr-10"
                    >
                    <button 
                        type="button" 
            ...
            <div class="text-center">
                ...
                <p class="text-sm">
                    Belum punya akun?
                    <a href="{{ route('register') }}" class="hover:underline text-blue-700 font-semibold">
                        Daftar di sini
                    </a>
                </p>
            </div>
    ...
    <script>
        function togglePassword() {
            ...
            if (passwordInput.type === "password") {
                ...
                eyeIcon.innerHTML = `
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.542-7a9.956 9.956 0 012.22-3.592m1.343-1.342A9.955 9.955 0 0112 5c4.477 0 8.268 2.943 9.542 7a9.965 9.965 0 01-4.293 5.045M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M3 3l18 18" />
                `;
            } else {
